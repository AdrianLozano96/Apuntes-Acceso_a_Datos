...
public class App {
    public static void main(String[] args) {
        //String INPUT_XML = System.getProperty("user.dir") + File.separator + "data" + File.separator + "users_updated3.xml";
        ...
        try {
            ...
            //CONSULTAS
            //System.out.println("Se obtienen las noticias las cuales sean de cultura");
            //List<String> categorias = new ArrayList<>();
            //controller.getNoticias().forEach(noticia->categorias.add(noticia.getCategoria().equals("Cultura")).collect(Collectors.toList()));
            //controller.getNoticias().stream().filter(noticia -> noticia.getCategoria().contains("Cultura")).forEach(System.out::println);
            //controller.getNoticias().stream().filter(noticia -> noticia.getCategoria().startsWith("Cultura")).forEach(System.out::println);
            ...
            System.out.println("Se obtienen los títulos de las noticias:");//Titulos
            controller.getAllTitulos().forEach(System.out::println);
            //System.out.println("Obtenemos todos los Ids");
            //controller.getAllIds().forEach(System.out::println);
            System.out.println("\n\nObtenemos el titulo del 5º elemento");//5º ELEMENTO DEL TITULO
            System.out.println(controller.getIndexTitulo(5));
            //System.out.println("Obtenemos el titulo del elemento con id 3M");
            //System.out.println(controller.getIndexTitulo(5));
//----------------------------------------------------------------------------------------------------------------------
            ...
            System.out.println("Se añade un elemento nuevo");//AÑADIR ELEMENTO
            controller.addElement("Periodico", "El Pais");
            //System.out.println("AActualizamos el ID");
            //controller.updateID();
            System.out.println("Se elimina al autor");//ELIMINA ELEMENTO
            ...
            controller.writeXMLFile(OUTPUT_XML2);//ESCRIBE
            controller.printXML();//MUESTRA
            System.out.println();
