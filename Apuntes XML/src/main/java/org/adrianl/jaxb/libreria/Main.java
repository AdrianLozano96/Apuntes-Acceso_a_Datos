...
public class Main {
    ...
    public static void marshal() throws JAXBException {    //Pasar del Objetos a XML
        ...
        Path p = Path.of(System.getProperty("user.dir") + File.separator + "data" + File.separator + "libros2.xml");
        marshall.marshal(milibreria, new File(String.valueOf(p)));
    }


    //Si ahora deseamos hacer lo contrario, es decir, leer los datos del documento XML y convertirlos a objetos Java
