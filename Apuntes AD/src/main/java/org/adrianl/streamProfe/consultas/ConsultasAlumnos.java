package org.adrianl.streamProfe.consultas;


import org.adrianl.streamProfe.model.Alumno;
...
public class ConsultasAlumnos {
    ...
    private void procesarStreams() {
        ...
        //listaAlumnos.forEach(a-> System.out.printl(a));
        // for(int i=0;i<listaAlumnos.size();i++){...} for(int i:listaAlumnos){...}
