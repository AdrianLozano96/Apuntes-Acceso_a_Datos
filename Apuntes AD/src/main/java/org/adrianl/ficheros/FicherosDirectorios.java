...
public class FicherosDirectorios {
    public static void main(String[] args) throws IOException {
        ...
        File fichero=new File("fichero.txt");// Debe existir
        File fichero2=new File("Nuevo Fichero.txt");// Luego se creará
        File directorio=new File("src"); // Debe existir y tener cosas
        File directorio2=new File("source"); //Luego se creará
